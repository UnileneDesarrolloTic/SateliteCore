...
namespace SatelliteCore.Api.ReportServices.Contracts.ControlCalidad
{
    ...
    {
        public string ReporteFormatoPruebaProtocolo(IEnumerable<DatosFormatoProtocoloPruebaModel> ListadoProtocolo, DatosFormatoNumeroLoteProtocoloModel Cabecera, bool Opcion)
        {
