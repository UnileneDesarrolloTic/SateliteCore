...
namespace SatelliteCore.Api.ReportServices.Contracts.Produccion
{
    ...
    {
        public string ReporteExcel(IEnumerable<SeguimientoCandMPAModel> listar, string regla)
        {
            byte[] file;
            string reporte = null;
            ...
            using (var excelPackage = new ExcelPackage())
            {
                ...
                worksheet.Cells["C3"].Value = "Descripción";
                ...
                worksheet.Cells["D3"].Value = "Alerta";
                ...
                worksheet.Cells["E3"].Value = "Duración";
                ...
                worksheet.Cells["F3"].Value = "S.Disponible";
                ...
                worksheet.Cells["G3"].Value = "PendienteOC";
                ...
                worksheet.Cells["H3"].Value = "Aduanas";
                ...
                worksheet.Cells["I3"].Value = "C Calidad";
                ...
                worksheet.Cells["J3"].Value = "C Variación";
                ...
                worksheet.Cells["K3"].Value = regla=="MPAGAR1" ? "Pronostico" : regla== "MPAG0R2" ? "Pro.Mensual" : regla== "MPAG0R3" ? "Pro.Mensual" : regla== "MPAG0R4" ? "Prom.12meses" : "Prom.4años";
                ...
                worksheet.Cells["L3"].Value = "L.Superior";
                ...
                worksheet.Cells["M3"].Value = "P.Control";
                ...
                worksheet.Cells["N3"].Value = "Maximo";
                ...
                worksheet.Cells["O3"].Value = "S Actual";
                ...
                worksheet.Cells["P3"].Value = "S Comprometido";
                ...
                foreach (SeguimientoCandMPAModel rowitem in listar)
                {
                    ...
                    worksheet.Cells["B" + row].Value = rowitem.Item;
                    ...
                    worksheet.Cells["C" + row].Value = rowitem.Descripcion;
                    ...
                    worksheet.Cells["D" + row].Value = rowitem.CantPedir;
                    ...
                    worksheet.Cells["E" + row].Value = rowitem.Duracion;
                    ...
                    worksheet.Cells["G" + row].Value = rowitem.PendienteOC;
                    ...
                    worksheet.Cells["H" + row].Value = rowitem.Aduanas;
                    ...
                    worksheet.Cells["I" + row].Value = rowitem.TransporteCC;
                    ...
                    worksheet.Cells["J" + row].Value = rowitem.CoeficienteVariacion;
                    ...
                    worksheet.Cells["L" + row].Value = rowitem.LimiteSuperior;
                    ...
                    worksheet.Cells["M" + row].Value = rowitem.PuntoControl;
                    ...
                    worksheet.Cells["N" + row].Value = rowitem.Maximo;
                    ...
                    worksheet.Cells["O" + row].Value = rowitem.StockActual;
                    ...
                    worksheet.Cells["P" + row].Value = rowitem.StockComprometido;
                    ...
                    if (rowitem.CantPedir>0)
                    {
                        worksheet.Cells["A" + row + ":P" + row].Style.Fill.BackgroundColor.SetColor(ColorTranslator.FromHtml("#ffff00"));
                    }
        ...
        private static void ConfigurarTamanioDeCeldas(ExcelWorksheet worksheet)
        {
            ...
            worksheet.Column(3).Width = 30.00 + 2.71;
        ...
        {
            worksheet.Cells["A3:P3"].Style.Font.Color.SetColor(ColorTranslator.FromHtml("#FFFFFF"));
            worksheet.Cells["A3:P3"].Style.Fill.BackgroundColor.SetColor(ColorTranslator.FromHtml("#155db1"));
        }
