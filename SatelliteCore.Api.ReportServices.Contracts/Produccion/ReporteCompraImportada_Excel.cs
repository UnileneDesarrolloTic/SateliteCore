...
namespace SatelliteCore.Api.ReportServices.Contracts.Produccion
{
    ...
    {
        public string GenerarReporte(IEnumerable<DatosFormatoLitadoSeguimientoCompraImportada> dato, string mostrarColumna)
        {
            ...
            {
                ExcelWorksheet worksheet = excelPackage.Workbook.Worksheets.Add("Compra Naciona e Importada");
                ...
                foreach (DatosFormatoLitadoSeguimientoCompraImportada rowitem in dato)
                {
