...
namespace SatelliteCore.Api.ReportServices.Contracts.Produccion
{
    public class ReporteExcelCompraDrogueria
    {
        ...
        private static void ConfigurarTamanioDeCeldas(ExcelWorksheet worksheet)
        {
            ...
            worksheet.Column(9).Width = 8.71 + 2.71;
            worksheet.Column(10).Width = 8.71 + 2.71;
            worksheet.Column(11).Width = 7.71 + 2.71;
            worksheet.Column(12).Width = 7.71 + 2.71;
            worksheet.Column(13).Width = 7.71 + 2.71;
            worksheet.Column(14).Width = 8.71 + 2.71;
            worksheet.Column(15).Width = 8.71 + 2.71; 
            worksheet.Column(16).Width = 8.71 + 2.71;
