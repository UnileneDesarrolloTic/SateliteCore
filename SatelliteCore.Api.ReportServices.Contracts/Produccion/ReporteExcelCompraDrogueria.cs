...
namespace SatelliteCore.Api.ReportServices.Contracts.Produccion
{
    ...
    {
        public string GenerarReporte(IEnumerable<DatosFormatoReporteSeguimientoDrogueria> dato, bool mostrarcolumna, IEnumerable<DatosFormatoGestionItemDrogueriaColor> condicionesgestion, string agrupador, DatosFormatoSeguimientoHistoricoPeriodoDrogueria informacionDrogueria)
        {
            byte[] file;
            string reporte = null;
