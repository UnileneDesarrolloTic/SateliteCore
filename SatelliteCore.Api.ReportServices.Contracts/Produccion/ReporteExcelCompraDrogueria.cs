    ...
    public class ReporteExcelCompraDrogueria
    {
        public string GenerarReporte(IEnumerable<DatosFormatoReporteSeguimientoDrogueria> dato, bool mostrarcolumna)
        {
            ...
            using (var excelPackage = new ExcelPackage())
            {
                ...
                worksheet.Cells["A3"].Value = "Itemfinal";
                ...
                worksheet.Cells["B3"].Value = "DescripcionFinal";
                ...
                worksheet.Cells["E3"].Value = "Tiempo Compra";
                ...
                worksheet.Cells["F3"].Value = "Tiempo Pago";
                ...
                worksheet.Cells["G3"].Value = "Tiempo Aprobación";
                ...
                worksheet.Cells["H3"].Value = "Tiempo Fabricación";
                ...
                worksheet.Cells["I3"].Value = "Tiempo Transporte";
                ...
                worksheet.Cells["J3"].Value = "Tiempo Aduanas";
                ...
                worksheet.Cells["K3"].Value = "Max stock linea";
                ...
                worksheet.Cells["L3"].Value = "Punto Corte";
                ...
                worksheet.Cells["M3"].Value = "Stock Disponible";
                ...
                worksheet.Cells["N3"].Value = "Stock transito";
                ...
                worksheet.Cells["O3"].Value = "Stock Total";
                ...
                worksheet.Cells["P3"].Value = "Stock Futuro";
                ...
                worksheet.Cells["Q3"].Value = "Cons.Mensual";
                ...
                worksheet.Cells["R3"].Value = "Cons.Diario";
                ...
                worksheet.Cells["S3"].Value = "Demora producto";
                ...
                worksheet.Cells["T3"].Value = "Dias Precaución";
                ...
                worksheet.Cells["U3"].Value = "Dias Espera";
                ...
                worksheet.Cells["W3"].Value = "Vol.Caja";
                ...
                worksheet.Cells["Z3"].Value = "PrecioFOBTotal";
                ...
                for(int i = 0;  i < grupo.Count(); i++)
                {
                    ...
                    {        
                            ...
                            worksheet.Cells["T" + row].Style.HorizontalAlignment = ExcelHorizontalAlignment.Justify;
                            ...
                            worksheet.Cells["U" + row].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                            ...
                            worksheet.Cells["W" + row].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                            ...
                            worksheet.Cells["X" + row].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                            ...
                            worksheet.Cells["Y" + row].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                            ...
                            worksheet.Cells["Z" + row].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;

                            costoFOB = costoFOB + rowitem.PrecioFOBFinal;
                    ...
                    worksheet.Cells["Y" + row].Value = costoFOB;
        ...
        {
            worksheet.Column(1).Width = 5.71 + 2.71;
            worksheet.Column(2).Width = 104.71 + 2.71;
            worksheet.Column(3).Width = 7.71 + 2.71;
            worksheet.Column(4).Width = 15.71 + 2.71;
            ...
            worksheet.Column(19).Width = 10.71 + 2.71;
            worksheet.Column(20).Width = 10.71 + 2.71;
            worksheet.Column(21).Width = 10.71 + 2.71;
            worksheet.Column(22).Width = 10.71 + 2.71;
            worksheet.Column(23).Width = 10.71 + 2.71;
            worksheet.Column(24).Width = 15.71 + 2.71;
            worksheet.Column(25).Width = 15.71 + 2.71;
            worksheet.Column(26).Width = 15.71 + 2.71;
        }
        ...
        {
            worksheet.Cells["A3:U3"].Style.Fill.BackgroundColor.SetColor(ColorTranslator.FromHtml("#77dd77"));
