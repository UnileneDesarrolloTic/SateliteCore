    ...
    public class ReporteLicitaciones
    {
        public string GenerarReporteDashboardLicitaciones(IEnumerable<DatosFormatodashboardLicitaciones>  documento)
        {
            ...
            using (var excelPackage = new ExcelPackage())
            {
                ...
                worksheet.Cells["F3"].Value = "Fecha Guia";
                ...
                worksheet.Cells["G3"].Value = "Monto Guiado";
                ...
                worksheet.Cells["H3"].Value = "Estado Facturación";
                ...
                worksheet.Cells["I3"].Value = "Factura";
                ...
                worksheet.Cells["J3"].Value = "Monto Factura";
                ...
                worksheet.Cells["K3"].Value = "Estado Comercial";
                ...
                worksheet.Cells["L3"].Value = "EstadoLogistica";
                ...
                worksheet.Cells["N3"].Value = "Usuario";
                ...
                worksheet.Cells["O3"].Value = "Monto Total Factura";
                ...
                foreach (DatosFormatodashboardLicitaciones rowitem in documento)
                {
                    ...
                    worksheet.Cells["F" + row].Value = rowitem.FechaGuia.ToString("dd/MM/yyyy");
                    ...
                    worksheet.Cells["G" + row].Value = rowitem.MontoGuiado;
                    ...
                    worksheet.Cells["H" + row].Value = rowitem.EstadoFacturacion;
                    ...
                    worksheet.Cells["I" + row].Value = rowitem.Factura;
                    ...
                    worksheet.Cells["J" + row].Value = rowitem.MontoFactura;
                    ...
                    worksheet.Cells["K" + row].Value = rowitem.EstadoComercial;
                    ...
                    worksheet.Cells["L" + row].Value = rowitem.EstadoLogistica;
                    ...
                    worksheet.Cells["M" + row].Value = rowitem.Estado;
                    ...
                    worksheet.Cells["N" + row].Value = rowitem.Usuario;
                    ...
                    worksheet.Cells["O" + row].Value = rowitem.MontoTotalFactura;
